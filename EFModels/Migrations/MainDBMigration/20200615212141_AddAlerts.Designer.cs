...
namespace EFModels.Migrations.MainDBMigration
{
    ...
    [Migration("20200615212141_AddAlerts")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EFModels.Alert", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EFModels.Alert", b =>
                {
                    b.HasOne("EFModels.MainDB.BPCase", "BPCase")
                        .WithMany("Alerts")
                        .HasForeignKey("BPCaseCaseId");
